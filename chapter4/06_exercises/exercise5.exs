defmodule Navigator do
  ...
  defp expand_dirs([], _relative_to, _current_siblings), do: []
  defp expand_dirs(_dirs, _relative_to, current_siblings) when current_siblings > @max_siblings, do: []
  defp expand_dirs([dir | dirs], relative_to, current_siblings) do
    expanded_dir = Path.expand(dir, relative_to)
    [expanded_dir | expand_dirs(dirs, relative_to, current_siblings + 1)]
  end
end
